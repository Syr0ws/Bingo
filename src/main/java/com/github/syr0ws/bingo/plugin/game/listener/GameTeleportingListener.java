...
public class GameTeleportingListener implements Listener {

    private final GameModel model;

    public GameTeleportingListener(GameModel model) {
    ...
    public void onPlayerMove(PlayerMoveEvent event) {
        ...
        boolean exists = this.model.hasPlayer(player.getUniqueId());

        if(exists) event.setTo(event.getFrom());
    }
